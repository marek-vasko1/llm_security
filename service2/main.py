...
class MCPClient:
    ...
    async def process_query(self, query: str):
        ...
        for i in range(10):
            ...
            status = sanitize_prompt(extracted_text)
            logger.debug(f"\n SANITIZE STATUS {status}\n")
            if (status > 0.6):
                return "I cannot answer this question, because it may try to bypass security guards"
...
async def query_endpoint(request: QueryRequest):
    ...
    Workflow:
        ...
        2. Validate output (via regex from rebuff)
