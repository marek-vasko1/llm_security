...
"""This code was implemented from rebuff project 
https://github.com/protectai/rebuff/blob/main/python-sdk/rebuff/detect_pi_heuristics.py
...
def sanitize_prompt(prompt: str):
    return detect_prompt_injection_using_heuristic_on_input(prompt)
