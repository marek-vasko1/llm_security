        ...
        with warnings.catch_warnings():
            ...
            try:
                with torch.no_grad():
                    ...
                    # =====================================================================
                    # 🕵️‍♂️ TVŮJ DEBUG: CO GARAK POSÍLÁ DO LOKÁLNÍHO MODELU
                    # =====================================================================
                    print("\n" + "="*70)
                    print(f"➡️ [GARAK POSÍLÁ DO LOKÁLNÍHO MODELU: {self.name}]")
                    ...
                    # =================================================================
                    # 🤖 TVŮJ DEBUG: CO LOKÁLNÍ MODEL VRÁTIL ZPĚT
                    # =================================================================
                    print("\n" + "="*70)
                    print(f"⬅️ [LOKÁLNÍ MODEL {self.name} ODPOVĚDĚL]")
                    for out_text in raw_text_output:
                        print(out_text)
                    print("="*70 + "\n")
